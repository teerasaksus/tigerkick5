...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['u764233228f4f6e3ee0c3c9c3c4fac068','u764233228f4f6e3ee0c3c9c3c4fac068','u764233228f4f6e3ee0c3c9c3c4fac068','u764233228f4f6e3ee0c3c9c3c4fac068'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command(`หาหมี ${payload}`,this.kickAll.bind(this));
        this.command(`เชินทำไม ${payload}`, this.cancelMember.bind(this));
